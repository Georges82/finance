...
function EditWeekPageContent() {
    ...
    const loadWeekReport = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiService"].getChatterWeeklyReport(chatterId, apiPeriodKey, parseInt(year), parseInt(week));
...
//# sourceMappingURL=src_2d6b0006._.js.map