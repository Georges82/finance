...
function EditWeekPageContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditWeekPageContent.useEffect": ()=>{
            const loadModels = {
                "EditWeekPageContent.useEffect.loadModels": async ()=>{
                    try {
            ...
            }["EditWeekPageContent.useEffect.loadModels"];
            loadModels();
        }
    }["EditWeekPageContent.useEffect"], [
        toast
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditWeekPageContent.useEffect": ()=>{
            const loadReportData = {
                "EditWeekPageContent.useEffect.loadReportData": async ()=>{
                    try {
                        if (!chatterId || chatterId === '1') {
                            setLoading(false);
                            return;
                        }
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].getChatterWeeklyReport(chatterId, periodKey, parseInt(year), parseInt(week));
                        console.log('Report data response:', response);
                        if (response.status === 'Success' && response.data && response.data.length > 0) {
                            // Build salaryResults from saved rows and populate dayEntries
                            const tempSalaryResults = {};
                            const updatedDayEntries = dayEntries.map({
                                "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries": (day)=>{
                                    const dayData = response.data.filter({
                                        "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.dayData": (item)=>item.work_date === day.date
                                    }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.dayData"]);
                                    // Prepare row breakdown to drive the UI "Total" per row and the day total
                                    if (dayData.length > 0) {
                                        const row_breakdown = dayData.map({
                                            "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown": (item)=>{
                                                const model = models.find({
                                                    "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown.model": (m)=>m.model_id === item.model_id
                                                }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown.model"]);
                                                ...
                                                if (isReferenceModel && item.reference_children && item.reference_children.length > 0) {
                                                    ...
                                                    refNetSales = referencedModels.map({
                                                        "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown": (refName)=>{
                                                            const child = item.reference_children.find({
                                                                "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown.child": (c)=>{
                                                                    const childModel = models.find({
                                                                        "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown.child.childModel": (m)=>m.model_id === c.model_id
                                                                    }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown.child.childModel"]);
                                                                    return childModel?.modelName === refName;
                                                                }
                                                            }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown.child"]);
                                                            return child ? child.net_sales : 0;
                                                        }
                                                    }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown"]);
                                                ...
                                                return {
                                                    ...
                                                    reference_children: item.reference_children || (isReferenceModel ? referencedModels.map({
                                                        "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown": (refName, index)=>({
                                                                model_id: models.find({
                                                                    "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown": (m)=>m.modelName === refName
                                                                }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown"])?.model_id || '',
                                                                model_name: refName,
                                                                net_sales: refNetSales[index] || 0,
                                                                hours: 0
                                                            })
                                                    }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown"]) : undefined)
                                                };
                                            }
                                        }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.row_breakdown"]);
                                        const total_salary = dayData.reduce({
                                            "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_salary": (sum, it)=>sum + (it.row_total || 0)
                                        }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_salary"], 0);
                                        const total_hours = dayData.reduce({
                                            "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_hours": (sum, it)=>sum + (it.hours || 0)
                                        }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_hours"], 0);
                                        const total_hourly_pay = dayData.reduce({
                                            "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_hourly_pay": (sum, it)=>sum + (it.hourly_pay || 0)
                                        }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_hourly_pay"], 0);
                                        const total_commission = dayData.reduce({
                                            "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_commission": (sum, it)=>sum + (it.commission || 0)
                                        }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.total_commission"], 0);
                                    ...
                                    return {
                                        ...day,
                                        models: dayData.map({
                                            "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries": (item)=>{
                                                const model = models.find({
                                                    "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.model": (m)=>m.model_id === item.model_id
                                                }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries.model"]);
                                                const referencedModels = model?.referencedModels || [];
                                                // Extract refNetSales from reference_children if available
                                                let refNetSales = undefined;
                                                if (item.reference_children && item.reference_children.length > 0) {
                                                    refNetSales = item.reference_children.map({
                                                        "EditWeekPageContent.useEffect.loadReportData.updatedDayEntries": (child)=>child.net_sales
                                                    }["EditWeekPageContent.useEffect.loadReportData.updatedDayEntries"]);
            ...
            }["EditWeekPageContent.useEffect.loadReportData"];
            ...
            if (models.length > 0) {
                ...
                const timer = setTimeout({
                    "EditWeekPageContent.useEffect.timer": ()=>setLoading(false)
                }["EditWeekPageContent.useEffect.timer"], 100);
                return ({
                    "EditWeekPageContent.useEffect": ()=>clearTimeout(timer)
                })["EditWeekPageContent.useEffect"];
            }
        }
    }["EditWeekPageContent.useEffect"], [
                        ...
                        models: day.models.map((model)=>{
                            if (model.id === modelId) {
                                if (field === 'modelId') {
                                    ...
                                    const refCount = selectedModel?.referencedModels?.length || 0;
                                    return {
                                        ...model,
                                        modelId: value,
                        ...
                        rows: day.models.map((model)=>{
                            ...
                            if (referencedModels.length > 0) {
                                ...
                                const referenceChildren = referencedModels.map((refModelName, index)=>{
                                    ...
                                    return {
                                        model_id: refModel?.model_id || refModelName,
                                        hours: model.hours / referencedModels.length,
        ...
        try {
            ...
            if (response.status === 'Success' && response.data) {
                setSalaryResults((prev)=>({
                        ...prev,
                        [dayEntry.date]: response.data
                    }));
                toast({
                    title: "Success",
                    description: `Salary calculated for ${new Date(dayEntry.date).toLocaleDateString('en-US', {
                        weekday: 'long',
                        month: 'long',
                        day: 'numeric'
                    })}.`
            ...
            for (const day of dayEntries){
                if (day.models && day.models.length > 0) {
                    ...
                    if (response.status === 'Success' && response.data) {
                        ...
                        results[day.date] = {
                            error: response.message || 'Calculation failed'
                        };
                    }
                } else {
                    results[day.date] = {
                        error: 'No models assigned for this day'
                    };
                }
            }
                        ...
                        children: [
                            ...
                            day.models.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                                ...
                                                children: [
                                                    day.models.map((model)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                            children: [
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                                                children: !models || models.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    lineNumber: 751,
                                                                                    columnNumber: 33
                                                                                }, this) : models.map((modelOption)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                                        value: modelOption.model_id,
                                                                                        children: modelOption.modelName
                                                                                    }, modelOption.model_id, false, {
                                                                                        fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                                        lineNumber: 754,
                                                                                        columnNumber: 35
                                                                                    }, this))
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                    children: (()=>{
                                                                        const selected = models.find((m)=>m.model_id === model.modelId);
                                                                        const refs = selected?.referencedModels || [];
                                                                        const refCount = refs.length;
                                                                        if (refCount > 0) {
                                                                            const values = model.refNetSales && model.refNetSales.length === refCount ? model.refNetSales : new Array(refCount).fill(0);
                                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                className: "flex flex-col gap-2",
                                                                                children: [
                                                                                    values.map((val, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                            className: "flex items-center gap-2",
                                                                                            children: [
                                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                    className: "text-xs text-muted-foreground",
                                                                                                    children: refs[i] || `Ref ${i + 1}`
                                                                                                }, void 0, false, {
                                                                                                    fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                                                    lineNumber: 790,
                                                                                                    columnNumber: 39
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                        ...
                                                                                        children: [
                                                                                            "Total: $",
                                                                                            values.reduce((s, v)=>s + (parseFloat(String(v)) || 0), 0)
                                                                                        ]
                                                                                    }, void 0, true, {
                                                                                        fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                                        lineNumber: 800,
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                    ...
                                                                    children: salaryResults[day.date]?.row_breakdown?.find((r)=>r.model_id === model.modelId) ? (()=>{
                                                                        const rowData = salaryResults[day.date].row_breakdown?.find((r)=>r.model_id === model.modelId);
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                className: "font-bold",
                                                                children: salaryResults[day.date]?.total_salary !== undefined ? `$${salaryResults[day.date].total_salary.toLocaleString()}` : '-'
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 846,
                                                                columnNumber: 23
                                    ...
                                    salaryResults[day.date] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-4 p-4 bg-blue-50 rounded-lg border",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                className: "font-semibold text-blue-900 mb-2",
                                                children: "Salary Calculation Results"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                lineNumber: 859,
                                                columnNumber: 21
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    "$",
                                                                    salaryResults[day.date].total_salary
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 863,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    "$",
                                                                    salaryResults[day.date].hourly_pay
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 867,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    "$",
                                                                    salaryResults[day.date].commission_total
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 871,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: salaryResults[day.date].model_count
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 875,
                                                                columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    "$",
                                                                    salaryResults[day.date].hourly_rate
                                                                ]
                                                            }, void 0, true, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 879,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: salaryResults[day.date].total_hours
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                lineNumber: 883,
                                                                columnNumber: 25
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-2",
                                                        children: salaryResults[day.date].row_breakdown?.map((row, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            row.is_reference_model && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "text-blue-600 font-medium",
                                                                                children: "Reference Model"
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                                                lineNumber: 899,
                                                                                columnNumber: 33
                                                            ...
                                                            className: "text-sm text-muted-foreground",
                                                            children: "No breakdown data available"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/reports/edit-week/page.tsx",
                                                            lineNumber: 903,
                                                            columnNumber: 31
...
_s(EditWeekPageContent, "mm0miAZZj1hoULzUw9Wr6zMvdXU=", false, function() {
    return [
...
//# sourceMappingURL=src_ebb4ad1d._.js.map