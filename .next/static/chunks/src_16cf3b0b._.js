    ...
    const weeklySnapshot = (()=>{
        ...
        if (dashboardData?.month_kpis?.period_breakdown) {
            return [
                {
                    week: 'Period 1',
                    revenue: dashboardData.month_kpis.period_breakdown.period_1?.revenue || 0,
                    costs: dashboardData.month_kpis.period_breakdown.period_1?.cost || 0,
                    profit: dashboardData.month_kpis.period_breakdown.period_1?.profit || 0,
                ...
                {
                    week: 'Period 2',
                    revenue: dashboardData.month_kpis.period_breakdown.period_2?.revenue || 0,
                    costs: dashboardData.month_kpis.period_breakdown.period_2?.cost || 0,
                    profit: dashboardData.month_kpis.period_breakdown.period_2?.profit || 0,
        ...
        if (dashboardData?.snapshot) {
            return [
                {
                    week: 'Total Period',
                    revenue: dashboardData.snapshot.revenue || 0,
                    costs: dashboardData.snapshot.cost || 0,
                    profit: dashboardData.snapshot.profit || 0,
                    change: 'N/A'
                }
            ];
        }
...
//# sourceMappingURL=src_16cf3b0b._.js.map